...
$receiver = $_GET['receiver']; // GET 방식으로 넘어온 받는 회원아이디
?>
<html>
<head>
	<title>Memo Form</title>
	<link href="./assets/css/memo_style.css" rel="stylesheet" type="text/css">
</head>
<body id="memo">
	<!-- 쪽지 보내기 시작 { -->
	<div>
		...
		<div>
			...
			<tr>
				<th>받는 회원아이디</th>
				<td>
					<input type="text" name="receiver" value="<?php echo $receiver ?>" id="receiver" required class="frm_input required" size="47"></br>
